...
export default function LandingPage() {
  ...
  return (
    <>
      <Head>
        <title>NewsAI - AI-Powered News Curation</title>
        <meta
          name="description"
      ...
      <main>
        ...
        <section className="testimonials">
          ...
          <div className="testimonial-grid reveal">
            <div className="testimonial-card">
              <p>
                “NewsAI - AI Article Curator is indispensable for my
            ...
            <div className="testimonial-card">
              <p>
                ...
                summaries. NewsAI - AI Article Curator’s AI ensures I’m
        ...
        <section className="faq">
          ...
          <div className="faq-list reveal">
            <details>
              <summary>What is NewsAI - AI Article Curator?</summary>
              <p>
                NewsAI - AI Article Curator is an AI-powered tool that
            ...
            <details>
              <summary>
                Who can benefit from NewsAI - AI Article Curator?
              </summary>
              <p>
          ...
          <div className="contact-grid reveal">
            <div className="contact-card">
              ...
              <p>
                ...
                <a href="https://www.linkedin.com/in/me-akash77/">LinkedIn</a>
              </p>
            </div>
            <div className="contact-card">
              <MdEmail size={32} />
              ...
              <p>
                Reach out at{" "}
                <a href="mailto:iakshu845@gmail.com">
                  iakshu845@gmail.com
                </a>
              </p>
            </div>
        ...
        <section className="final-cta reveal">
          ...
          <p className="section-subtitle">
            Join thousands using NewsAI - AI Article Curator daily.
          </p>
